    ...
    >
      ...
      >
        <svg width="28" height="28" viewBox="0 0 32 32" fill="none">
          ...
          <line x1="8" y1="10" x2="24" y2="10" stroke="var(--border-light)" strokeWidth="1.2" strokeDasharray="2 2" />
        </svg>
      </motion.div>
      ...
      >
        A local-first second brain for teams
      </motion.p>

      <motion.p
        className="mb-12 max-w-xl text-center text-base text-[var(--text-muted)]"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ duration: 0.5, delay: 0.45 }}
      >
        Per-project brain dumps from every teammate, synthesized into a shared knowledge graph
        of agreements, contradictions, and what to move on next
      </motion.p>
      ...
      >
        ...
        <span className="text-xs text-[var(--text-muted)]">
          11 slides · arrow keys to navigate
        </span>
      </motion.div>
